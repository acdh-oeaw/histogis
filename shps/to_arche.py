...
def serialize_project():
    ...
    g.add(
        (
            ...
            Literal(PROJECT_METADATA["description"], lang="en"),
        )
    )
    ...
    g.add(
        (pmarck, ARCHE.hasTitle, Literal("Peter Paul Marckhgott-Sanabria", lang="de"))
    )
    ...
    g.add((project, ARCHE.hasSubject, Literal("History", lang="en")))
    g.add((project, ARCHE.hasSubject, Literal("GIS", lang="en")))
    g.add((topcol, ARCHE.hasSubject, Literal("History", lang="en")))
    g.add((topcol, ARCHE.hasSubject, Literal("GIS", lang="en")))
    g.add(
        (
            project,
    ...
    g.add(
        (topcol, ARCHE.hasCoverageStartDate, Literal("1815-01-01", datatype=XSD.date))
    )
    ...
    g.add((vecol, ARCHE.hasSubject, Literal("History", lang="en")))
    g.add((vecol, ARCHE.hasSubject, Literal("GIS", lang="en")))
